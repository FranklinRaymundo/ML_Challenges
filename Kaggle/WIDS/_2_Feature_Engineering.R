...
saveRDS(test,'./ShinyApp/test_orig.rda')
...
feature_engineering <- function(tb){
    ...
    tb[,'MM3__missing'] <- NULL
    tb[,c('FF7_3','FF7_6','FF7_7','ir_banco_nosabe','ir_ATM_nosabe')] <- NULL
...
saveRDS(train_feat,'./ShinyApp/train_feat.rda')
saveRDS(test_feat,'./ShinyApp/test_feat.rda')
